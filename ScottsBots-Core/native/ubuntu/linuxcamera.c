...
#include <sys/ioctl.h>
#include <jni.h>
#include "com_scottsbots_core_vision_LinuxCamera.h"
#include <stdlib.h>
#include <stdint.h>
#include <ctype.h>
#include <string.h>
...
JNIEXPORT void JNICALL Java_com_scottsbots_core_vision_LinuxCamera_init (JNIEnv *env, jobject this, jstring str) {
...
JNIEXPORT jbyteArray JNICALL Java_com_scottsbots_core_vision_LinuxCamera_getNativeImage  (JNIEnv *env, jobject this)
{
